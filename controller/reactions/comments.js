...
const { Comments } = require('../../models/reactions/reactions.js.js')
...
const createComment = async(req, res) => {
    ...
    try {
        ...
        try {
            ...
            const updatePostsCommentsArray = await Posts.updateOne({ user_id: commenter_id }, {
                $set: {
...
const updateComment = async(req, res) => {
    ...
    try {
        const updatedComment = await Comments.updateOne({ _id: post.post_id }, {
            $set: {
                comment: value.comment,
                edited: true,
            },
...
const deleteComment = async(req, res) => {
    ...
    try {
        ...
        await Auths.updateOne({ commenter_id }, {
            $set: {
                posts: otherPosts,
            },
        }, )
